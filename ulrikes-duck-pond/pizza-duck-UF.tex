...
\AddToShipoutPictureBG{%
 ...
 %\draw(red)  ($(current page.west)+(-2,-2)$) --++ (; 
 \fill[DodgerBlue2,decorate, decoration={snake,segment length={10mm}}] ([xshift=-2cm,yshift=-2cm]current page.west) rectangle ([xshift=1cm,yshift=-2cm]current page.south east);
 \node[anchor=north] at(current page.north) {\includegraphics[scale=0.5]{sun-unesco}};

 \end{tikzpicture}}}


\begin{tikzpicture}
\path[use as bounding box](0,0)--++(\textwidth,\textheight);
\begin{scope}[xshift=0cm, yshift=2ex,]
		\duck[]
\node[rotate=-20,transform shape] at (2,1) {\includegraphics[width=1.5cm]{bc-ditalie.mps}};
\path(0.7,1) pic[rotate=-20,scale=1.2] {pizza};
\end{scope}

\begin{scope}[xshift=2cm, yshift=2ex,]
		\duck[]
\node[rotate=-20,transform shape] at (2,1) {\includegraphics[width=1.5cm]{bc-ditalie.mps}};
\path(0.7,1) pic[rotate=-20,scale=1.2] {pizza};
\end{scope}
...
\begin{scope}[xshift=6cm, yshift=2ex,]
		\duck[]
\node[rotate=-20,transform shape] at (2,1) {\includegraphics[width=1.5cm]{bc-ditalie.mps}};
\path(0.7,1) pic[rotate=-20,scale=1.2] {pizza};
\end{scope}

\begin{scope}[xshift=9cm,yshift=2ex,scale=0.6,transform shape]
...
\node[rotate=-20,transform shape] at (2,1) {\includegraphics[width=1.5cm]{blackmap.mps}\raisebox{1.1cm}{\hspace{-1.25cm}\includegraphics[scale=1.6,angle=-40]{pineapple}}};
